<nav class="side-nav">
    <a href="" class="intro-x flex items-center pl-5 pt-4">
        <img alt="Midone Tailwind HTML Admin Template" class="w-6" src="{{ asset('dashboard-assets/dist/images/eplastic-logo.png') }}">
        <span class="hidden xl:block text-white text-lg ml-3"> E<span class="font-medium">plastic</span> </span>
    </a>
