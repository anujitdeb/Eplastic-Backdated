...
Route::group(['prefix' => 'eplastic'], function () {
    Route::get('/', 'App\Http\Controllers\DashboardController@index')->name('dashboard');
    Route::get('registration', 'App\Http\Controllers\DashboardController@registration')->name('registration');
    Route::post('userInsert', 'App\Http\Controllers\DashboardController@insertUser')->name('userInsert');
